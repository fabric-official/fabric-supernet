...
def main():
    ...
    size_mb = int(cfg.get("target_size_mb", 14))
    ...
    seed = ("SmartphoneAgent|FABRIC|TRAIN|v7").encode("utf-8")
    seed += fold_dataset(ds)
    if not seed:
        seed = ("SmartphoneAgent|FABRIC|TRAIN|EMPTY").encode("utf-8")
    seed = seed * 4096
    ...
    meta = {"agent":"SmartphoneAgent","size_mb":size_mb,"sha256":sha}
