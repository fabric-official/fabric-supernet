...
def main():
    ...
    size_mb = int(cfg.get("target_size_mb", 12))
    ...
    seed = ("DroneAgent|FABRIC|TRAIN|v7").encode("utf-8")
    seed += fold_dataset(ds)
    if not seed:
        seed = ("DroneAgent|FABRIC|TRAIN|EMPTY").encode("utf-8")
    seed = seed * 4096
    ...
    meta = {"agent":"DroneAgent","size_mb":size_mb,"sha256":sha}
