...
// Lightweight API client with sane defaults, timeout, and simple SSE/WS helpers.
export const config = {
...
// WebSocket helper with auto-retry (jittered backoff)
